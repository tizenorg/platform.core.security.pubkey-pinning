...
/*
 *  @brief   Sets system trust certificate store to verify peer certificates.
 *
 *  @remarks Sets valid ca-bundle file or trusted store directory path
 *           by using gnutls_certificate_set_x509_trust_* internally.
 *
 *  @param[in] credentials  gnutls credentials
 *
