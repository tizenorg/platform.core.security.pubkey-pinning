...
void answerAllow(void *data, Evas_Object * /* obj */, void * /* event_info */)
{
	SLOGD("allow answer");
...
void answerDeny(void *data, Evas_Object * /* obj */, void * /* event_info */)
{
	SLOGD("deny answer");
...
void showPopup(TpkpPopup *pdp)
{
	...
	evas_object_smart_callback_add(pdp->buttonAllow, "clicked", answerAllow, pdp);
	...
	evas_object_smart_callback_add(pdp->buttonDeny, "clicked", answerDeny, pdp);
